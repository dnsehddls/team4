...
<head>
    ...
    <link rel="stylesheet" href="${contextPath}/resources/css/member/like.css">
...
<body>
                    ...
                    <tbody>
                        <c:choose>
                            <c:when test="${empty likeList}">
                                <!-- 내 게시글 조회결과가 비어있다면  -->
                                <tr>
                                    <th colspan="3">좋아요한 게시글이 없습니다.</th>
                                </tr>
                            </c:when>
    ...
    <!-- js -->
    <script src="${contextPath}/resources/js/member/like.js"></script>
