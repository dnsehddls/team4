...
function goPopup(){
	...
	var pop = window.open("../../../WEB-INF/views/board/mapApi/jusoPopup.jsp", "pop","width=570,height=420, scrollbars=yes, resizable=yes"); 
...
function jusoCallBack(roadFullAddr){
		...
		var addressEI = document.getElementById("SearchMap");
